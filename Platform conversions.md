...
Fabric usually uses droplets, where 1 bucket ≙ 81,000 droplets,
while neoforge uses the traditional millibuckets (mB) system, where
1 bucket ≙ 10,000 mB

This template can automatically convert fluid units to the correct
one like this:
```json5
{
  // ...
